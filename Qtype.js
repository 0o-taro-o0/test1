...
const data = {
  "title": "アンケートのタイトル",
  "explanation": "こんにちは。私たちは、山口大学国際総合科学部のプロジェクト型課題解決研究（PBL）の一環として、山口県の農業の担い手不足について取り組んでいます。当アンケートは大学生を対象に、農業に対する意識調査を目的として実施しています。このアンケートの結果は、PBLでの研究活動のみで使用し、第三者へ情報を提供することもございませんので、回答にご協力宜しくお願い致します。<br>※当アンケートは回答者様の意思により途中で回答を止めることができます。<br>\r\n※また、回答したくない質問については、ご回答頂かなくても構いません。",
  "QSections": [
    {
      "sectionTitle":"基本情報",
      "questions"   :[
    ...
    },
    {
      ...
      "questions":[
        ...
        },
        {
          ...
          "QType"   : {
            "type"   :"textfield",
            "varName":"workChoiceImportantOther",
            "items"  :"",
            "option" :""
          }
        }
    ...
    },
    {
      ...
      "questions":[
        {
          "memo": "農業に対してどのようなイメージを持ちますか？"
        },
        {
          "question": "日本の平均所得より高い",
          "QType"   : {
            "type"   :"radio",
            "varName":"income",
            "items"  :"think",
